...
%     plot(time_vector(2802:4603),error_pos(i,2802:4603),'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603),error_rpy(i,2802:4603),'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603),error_vel(i,2802:4603),'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603),error_ang_vel(i,2802:4603),'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603), pos_des(i,2802:4603),'b',time_vector(2802:4603), pos(i,2802:4603),'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603), rpy_des(i,2802:4603), 'b', time_vector(2802:4603), rpy(i,2802:4603), 'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603), vel_des(i,2802:4603), 'b', time_vector(2802:4603), vel(i,2802:4603), 'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
...
%     plot(time_vector(2802:4603), ang_vel_des(i,2802:4603),'b',time_vector(2802:4603), ang_vel(i,2802:4603),'r');
    grid on
    xlabel('time [s]')
    ylabel(labels{i})
    title(title_name{i})
